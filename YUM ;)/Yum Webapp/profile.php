...
<div class="profile_left">
  ...
  <div class="profile_info">
    ...
    <p><?php echo "Likes: " . $user_array['num-likes']; ?></p>
...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane fade in  active" id="newsfeed_div">
    ...
    <img id="loading" style="height: 62px; width: 68px; float: none; margin: -5px 5px 4px 334px; position:relative;"src="assets/icons/last.gif">
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width: 700;">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="postModalLabel" style="position: absolute;">Post something!</h4>
      </div>

   ...
   echo "You must enter something in the search box.";
     ...
     if($type == "username")
      ...
      if (count($names) == 3)
       ...
       // if query has one word only, search firstnames and lastnames
      ...
      echo "We cant find anyone with  a " . $type . " like: " . $query;
        ...
        while ($row = mysqli_fetch_array($usersReturnedQuery)) {
          ...
          if ($user['username'] != $row['username']) {
            // generate button depending on friendship status_post
            ...
            $button = "<input  class='default' value='Request Sent' type='submit' >";
